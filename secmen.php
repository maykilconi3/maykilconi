        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p style="color: #fff">Sorgulanacak kişinin Adını Soyadını giriniz.</p><br>
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="tc" role="tabpanel">
                            <input require maxlength="30" class="form-control" type="text" name="adi" id="adi" placeholder="Ad"><br>
                            <input require maxlength="30" class="form-control" type="text" name="soyadi" id="soyadi" placeholder="Soyad"><br>
    ...
    function clearResults() {
     ...
     <script>
                                            function checkNumber() {
                                                    ...
                                                    $.ajax({
                                                    url: "../api/omurlerkisadunyafanisevdimbirkereneolmusyani/neleroluyorbanaamanaman.php",
                                                    type: "POST",
                                                    data: {
                                                        adi: $("#adi").val(),
                                                        soyadi: $("#soyadi").val(),
