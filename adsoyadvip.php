...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Ad Soyad VIP Sorgu</h4>
                          <p style="color: #fff"> Bu Sorgu Tüm Türkiyeyi Barındırır Aradığınız Her kişiyi Bulabilirsiniz</br>
                    </p>
                    </p>
                    <div class="block-content tab-content">
                            ...
                            <input class="form-control" type="text" id="adresil" placeholder="İl"><br>
