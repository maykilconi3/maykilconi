        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p style="color: #fff">Bu sorgu 100 milyon veriden oluşmaktadır. Sorgu üyeliğinize dahil değildir. Sorgu adeti 10TL'dir Satın almak için @frozzylxst yazınız.</p><br>
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="tcx" role="tabpanel">
                            <input require maxlength="11" class="form-control" type="text" name="gsm" id="gsm" placeholder="Numara Giriniz"><br>
                                ...
                                <table id="zero-conf" class="table table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: white; font-weight: bold;">SORGULANAN TELEFON</th>
                                            <th style="color: white; font-weight: bold;">TC KİMLİK NUMARASI</th>
                                        </tr>
                                    </thead>
